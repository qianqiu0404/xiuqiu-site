...
test('learning UI keeps API contracts, abort/cursor safety, vertical timeline structure and route compatibility', () => {
  ...
  assert.doesNotMatch(page, /learn-featured__grid|featuredCards/)
  ...
  assert.match(page, /futureGroups/)
  assert.match(page, /learn-date-group/)
  assert.match(page, /group\.items\.length }} 条/)
